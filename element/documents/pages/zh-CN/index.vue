...
<template>
  <div>
    ...
    <div class="jumbotron" ref="indexMainImg">
      <img src="~documents/assets/images/theme-index-blue.png" alt="">
      <div class="jumbotron-red" :style="{
           height: mainImgOffset + 'px'
         }">
        <img src="~documents/assets/images/theme-index-red.png" alt="">
      </div>
    </div>
    <div class="sponsors">
      <a class="sponsor" href="https://tipe.io/?ref=element" target="_blank" v-show="lang !== 'zh-CN'">
        <img width="35px" src="~documents/assets/images/tipe.svg" alt="tipe.io">
        <div>
      ...
      <a class="sponsor" href="https://www.duohui.cn/?utm_source=element&utm_medium=web&utm_campaign=element-index" target="_blank">
        <img width="45px" src="~documents/assets/images/duohui.svg" alt="duohui">
        <div>
          <p>Sponsored by 多会</p>
          <p>炫酷的新一代活动票务系统</p>
        </div>
    ...
    <div class="cards">
      <ul class="container">
        <li>
          <div class="card">
            <img src="~documents/assets/images/guide.png" alt="">
            <h3>指南</h3>
        ...
        <li>
          <div class="card">
            <img src="~documents/assets/images/component.png" alt="">
            <h3>组件</h3>
